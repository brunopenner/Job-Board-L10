<div class="relative">
    @if($formId)
        <button type="button" class="absolute top-0 right-1 flex h-full items-center" onclick="document.getElementById('{{ $name }}').value = ''; document.getElementById('{{$formId}}').submit();">
